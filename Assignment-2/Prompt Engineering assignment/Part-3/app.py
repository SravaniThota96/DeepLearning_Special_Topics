...
OPENAI_API_KEY = os.environ.get('OPENAI_API_KEY', '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')
embeddings = OpenAIEmbeddings(openai_api_key=OPENAI_API_KEY)

# Initialize Pinecone
PINECONE_API_KEY = os.environ.get('PINECONE_API_KEY', '5bae6945-3751-4a8e-a302-b9b84c17d2a0')
